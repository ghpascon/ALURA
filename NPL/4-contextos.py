...
if __name__ == "__main__":
    ...
    nome_arquivo = os.path.join(model_dir, "modelo_npl.pkl")
    ...
    nome_arquivo = os.path.join(model_dir, "vetor_npl.pkl")
    with open(nome_arquivo, 'wb') as arquivo:
    ...
    nome_arquivo = os.path.join(model_dir, "accuracy.pkl")
    with open(nome_arquivo, 'wb') as arquivo:
    ...
    nome_arquivo = os.path.join(model_dir, "df_freq.pkl")
    with open(nome_arquivo, 'wb') as arquivo:
    ...
    # Salvar all_words
    nome_arquivo = os.path.join(model_dir, "all_words.pkl")
    with open(nome_arquivo, 'wb') as arquivo:
