...
if __name__ == '__main__':
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint(filepath='keras/model/best_model.hdf5', monitor='val_loss', save_best_only=True),
        ]

    optmizer=keras.optimizers.Adam(learning_rate=0.001, beta_1=0.9, beta_2=0.999)
